...
<div class="page-content row">
    ...
    <div class="page-content-wrapper">
        ...
        <div class="col-md-6">
            <strong>
                <p> Red : Registration not yet complete. </p>

                <p> Yellow : Registration complete but not yet processed by accountant. </p>

                <p> Green : Registration complete and processed. </p>
            </strong>
        </div>
    </div>

...
<div class="col-md-12">
						<fieldset><legend> Service & Maintainance</legend>
							...
							class='select2 '  required  ></select> 
								  ...
								  <div class="form-group  " >
									<label for="Equipment / Appliance" class=" control-label col-md-4 text-left"> Equipment / Appliance </label>
									<div class="col-md-6">
					...
					<input type='radio' name='monitor_in_checks' value ='0'  @if($row['monitor_in_checks'] == '0') checked="checked" @endif > No </label>
					<label class='radio radio-inline'>
					<input type='radio' name='monitor_in_checks' value ='1'  @if($row['monitor_in_checks'] == '1') checked="checked" @endif > Yes </label> 
									 </div> 
									 <div class="col-md-2">
					...
					<label class='radio radio-inline'>
					<input type='radio' name='active' value ='0'  @if($row['active'] == '0') checked="checked" @endif > No </label>
					<label class='radio radio-inline'>
					<input type='radio' name='active' value ='1'  @if($row['active'] == '1') checked="checked" @endif > Yes </label> 
									 </div> 
									 <div class="col-md-2">
			...
			<div style="clear:both"></div>	
			  ...
			  <div class="form-group">
				...
				<button type="button" onclick="location.href='{{ URL::to('maintenance?md='.$masterdetail["filtermd"].$trackUri) }}' " id="submit" class="btn btn-success ">  {{ Lang::get('core.sb_cancel') }} </button>
				</div>	  

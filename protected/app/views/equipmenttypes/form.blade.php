...
<div class="col-md-12">
						<fieldset><legend> Equipment & Asset Types</legend>
			...
			<div style="clear:both"></div>	
			  ...
			  <div class="form-group">
				...
				<button type="button" onclick="location.href='{{ URL::to('equipmenttypes?md='.$masterdetail["filtermd"].$trackUri) }}' " id="submit" class="btn btn-success ">  {{ Lang::get('core.sb_cancel') }} </button>
				</div>	  
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$("#created_by").jCombo("{{ URL::to('equipmenttypes/comboselect?filter=tb_users:id:id|first_name|last_name') }}",

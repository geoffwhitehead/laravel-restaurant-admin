...
<div class="page-content row">
    ...
    <div class="page-content-wrapper">
        ...
        <div class="alert alert-info" role="alert">
            ...
            <p><strong>Status Colours:</strong> Yellow: Training complete <br> <strong>Note:</strong> Sign off staff training by selecting the row and pressing the "Sign Off Training" button.</p>
        </div>
        @include('footer')

...
<div class="col-md-12">
						<fieldset><legend> Shifts</legend>
								  ...
								  <div class="form-group  " >
									<label for="Employee Id" class=" control-label col-md-4 text-left"> Employee Id <span class="asterix"> * </span></label>
									<div class="col-md-6">
							...
							class='select2 '  required  ></select> 
								  ...
								  <div class="form-group  " >
									<label for="Shift Date" class=" control-label col-md-4 text-left"> Shift Date <span class="asterix"> * </span></label>
									<div class="col-md-6">
									  
				{{ Form::text('shift_date', $row['shift_date'],array('class'=>'form-control datetime', 'style'=>'width:150px !important;')) }} 
									 </div> 
									 <div class="col-md-2">
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$("#site_id").jCombo("{{ URL::to('shift/comboselect?filter=sites:id:id|address_city') }}",

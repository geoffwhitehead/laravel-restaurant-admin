...
<div class="col-md-12">
				...
				{{ Form::text('clock_out_time', $row['clock_out_time'],array('class'=>'form-control datetime', 'style'=>'width:150px !important;')) }} 
					...
					<input type='radio' name='manager_conf_flag' value ='0'  @if($row['manager_conf_flag'] == '0') checked="checked" @endif > Inactive </label>
					<label class='radio radio-inline'>
					<input type='radio' name='manager_conf_flag' value ='1'  @if($row['manager_conf_flag'] == '1') checked="checked" @endif > Active </label> 
									 </div> 
									 <div class="col-md-2">
				...
				{{ Form::text('admin_conf_on', $row['admin_conf_on'],array('class'=>'form-control datetime', 'style'=>'width:150px !important;')) }} 
					...
					<label class='radio radio-inline'>
					<input type='radio' name='paid' value ='0'  @if($row['paid'] == '0') checked="checked" @endif > Inactive </label>
					<label class='radio radio-inline'>
					<input type='radio' name='paid' value ='1'  @if($row['paid'] == '1') checked="checked" @endif > Active </label> 
									 </div> 
									 <div class="col-md-2">

...
<div class="col-md-12">
						<fieldset><legend> Employees</legend>
							...
							class='select2 '  required  ></select> 
								  ...
								  <div class="form-group  " >
									<label for="Organisation Id" class=" control-label col-md-4 text-left"> Organisation Id <span class="asterix"> * </span></label>
									<div class="col-md-6">
				...
				{{ Form::text('employment_start', $row['employment_start'],array('class'=>'form-control date', 'style'=>'width:150px !important;')) }} 
								  ...
								  <div class="form-group  " >
									<label for="Employment End" class=" control-label col-md-4 text-left"> Employment End </label>
									<div class="col-md-6">
									  
				{{ Form::text('employment_end', $row['employment_end'],array('class'=>'form-control date', 'style'=>'width:150px !important;')) }} 
									 </div> 
									 <div class="col-md-2">
			...
			<div style="clear:both"></div>	
			  ...
			  <div class="form-group">
				...
				<button type="button" onclick="location.href='{{ URL::to('employees?md='.$masterdetail["filtermd"].$trackUri) }}' " id="submit" class="btn btn-success ">  {{ Lang::get('core.sb_cancel') }} </button>
				</div>	  

    ...
    <div class="page-content-wrapper">
        ...
        <div class="col-md-3" id="sale-group">
            <fieldset>
                ...
                <div class="form-group  ">
                    ...
                    <div class="col-md-6">
                        {{ Form::text('ignore', $row['site_id'], array( 'class'=>'form-control','placeholder'=>'', 'readonly'=>'true' )) }}
                    </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                ...
                <button type="button" onclick="location.href='{{ URL::to('saleedit?md='.$masterdetail["filtermd"].$trackUri) }}' " id="submit" class="btn btn-success ">  {{ Lang::get('core.sb_cancel') }} </button>
            </div>

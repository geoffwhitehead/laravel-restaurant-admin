  ...
  <div class="page-content row">
    ...
    <div class="page-header">
      ...
      <ul class="breadcrumb">
		...
		<li><a href="{{ URL::to('docs?md='.$filtermd) }}">{{ $pageTitle }}</a></li>
 	...
 	<div class="page-content-wrapper">
		...
		<ul class="parsley-error-list">
		 ...
		 {{ Form::open(array('url'=>'docs/save/'.SiteHelpers::encryptID($row['id']).'?md='.$filtermd.$trackUri, 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) }}
<div class="col-md-12">
						<fieldset><legend> Document Repository</legend>
					...
					{{ SiteHelpers::showUploadedFile($row['file'],'/uploads/docs/') }}
			...
			<div style="clear:both"></div>	
			  ...
			  <div class="form-group">
				...
				<button type="button" onclick="location.href='{{ URL::to('docs?md='.$masterdetail["filtermd"].$trackUri) }}' " id="submit" class="btn btn-success ">  {{ Lang::get('core.sb_cancel') }} </button>
				</div>	  
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$("#site_id").jCombo("{{ URL::to('docs/comboselect?filter=sites:id:id|address_city') }}",

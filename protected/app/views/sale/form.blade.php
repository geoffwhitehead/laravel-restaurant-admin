        ...
        <div class="col-md-3">
            <fieldset>
                ...
                <div class="form-group  ">
                    ...
                    <div class="col-md-6">
                        {{ Form::text('total_cash_invoices', $inv[0]->amt,array('value'=>$inv[0]->amt,'class'=>'form-control', 'placeholder'=>'', 'required'=>'true', 'parsley-type'=>'number'  ,'id' => 'total-cash-invoices', 'readonly'=>'true',)) }}

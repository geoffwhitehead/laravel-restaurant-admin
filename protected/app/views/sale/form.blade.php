<div class="page-content row" xmlns="http://www.w3.org/1999/html">
    <!-- Page header -->
    ...
    <div class="page-content-wrapper">
        ...
        <div class="col-md-12">
            ...
            <fieldset>
                ...
                <div class="form-group  ">
                    <label for="Correction Comments" class=" control-label col-md-2 text-left"> Correction
                        Comments </label>
                ...
                <div class="form-group  ">
                    <label for="Cash Variance Comments" class=" control-label col-md-2 text-left"> Cash Variance
                        Comments </label>
                ...
                <div class="form-group  ">
                    <label for="Staff Disc Comments" class=" control-label col-md-2 text-left"> Staff Disc
                        Comments </label>

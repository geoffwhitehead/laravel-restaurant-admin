...
<div class="col-md-12">
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$("#user_id").jCombo("{{ URL::to('trainingrecordsfull/comboselect?filter=tb_users:id:id') }}",
		{  selected_value : '{{ $row["user_id"] }}' });
		
		$("#training_task_id").jCombo("{{ URL::to('trainingrecordsfull/comboselect?filter=training_tasks:id:id') }}",
		{  selected_value : '{{ $row["training_task_id"] }}' });
		
		$("#conf_completed_by").jCombo("{{ URL::to('trainingrecordsfull/comboselect?filter=tb_users:id:id') }}",
		{  selected_value : '{{ $row["conf_completed_by"] }}' });
		
		$("#created_by").jCombo("{{ URL::to('trainingrecordsfull/comboselect?filter=tb_users:id:id') }}",

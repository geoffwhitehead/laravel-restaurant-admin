        ...
        <div class="form container">
            ...
            <div class="col-md-12">
                <fieldset>
                    ...
                    <div class="form-group  ">
                        <label for="opening_comments" class=" control-label col-md-4 text-left"> Comments on the Opening
                            Checks </label>
                    ...
                    <div class="form-group  ">
                        <label for="closing_comments" class=" control-label col-md-4 text-left"> Comments on the Closing
                            Checks </label>
                    ...
                    <div class="form-group  ">
                        ...
                        <div class="alert alert-info col-md-6" role="alert">
                            <p><span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>
                                ...
                                Use the Notes section to include any information on additional / extra checks. Or any general problems that occurred that don't relate to specifically opening or closing checks </p>
                        </div>
                        <div class="col-md-2"></div>

                    </div>
                    <div class="form-group  ">
                        <label for="checks" class=" control-label col-md-4 text-left"> Completed Opening and Closing
                            Checks? </label>
                    ...
                    <div class="form-group  ">
                        ...
                        <div class="alert alert-warning col-md-6" role="alert">
                            <p><span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>
                                ...
                                By ticking the checkbox and submitting the log you are confirming that the safe methods were followed and effectively supervised today.</p>
                        </div>
                        <div class="col-md-2"></div>
        ...
        <div class="col-md-12">
            <div class="alert alert-success" role="alert">
                <p><span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>
                    ...
                    <strong></strong><br> Your site has already submitted a log within the last working day (16 hrs).

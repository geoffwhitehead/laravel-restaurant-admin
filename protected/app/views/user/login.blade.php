        ...
        <div class="animated fadeInUp delayp1">
            ...
            <div class="form-group has-feedback text-center">
                ...
                <div style="padding:15px 0;">
                    @if($fb_enabled =='true')
                        <a href="{{ URL::to('user/facebook')}}" class="btn btn-primary"><i class="fa fa-facebook"></i>
                            Facebook </a>
                    @endif
                    @if($google_enabled =='true')
                        <a href="{{ URL::to('user/google')}}" class="btn btn-danger"><i class="fa fa-google-plus"></i>
                            Google </a>
                    @endif
                    @if($twit_enabled =='true')
                        <a href="{{ URL::to('user/twitter')}}" class="btn btn-info"><i class="fa fa-twitter"></i>
                            Twitter </a>
                    @endif
                </div>
